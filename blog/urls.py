...
from .views import edit_post , delete_post, users_dashboard, userspost_create, favourite_add, favourite_list, UserProfile
...
urlpatterns = [
    ...
    path('edit_profile/', UserProfile.as_view(), name='edit_profile'),
